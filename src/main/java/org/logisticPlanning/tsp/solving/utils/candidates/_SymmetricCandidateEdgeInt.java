 ...
 * </p>
 * <p>
 * A class that assigns on int to each edge, specialized for symmetric TSPs
 * and using an {@code int} array as backing store. The size of the backing
 * store is {@code m*n}, where {@code m} is the number of candidate
 ...
 * corresponding
 * {@link org.logisticPlanning.tsp.solving.utils.edgeData.EdgeInt} data
 ...
 * this symmetric version of the {@code int}-array backed
 ...
 * </p>
 */
final class _SymmetricCandidateEdgeInt extends CandidateEdgeNumber {
   ...
   *          the candidates
   */
  _SymmetricCandidateEdgeInt(final int n, final _CandidateSubSet candidates) {
    super(n, candidates);
    this.m_data = new int[n * this.m_m];
  }
