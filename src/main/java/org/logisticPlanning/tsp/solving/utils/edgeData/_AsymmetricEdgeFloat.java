 ...
 * </p>
 * <p>
 * A class that assigns on float to each edge, specialized for asymmetric
 * TSPs.
 * </p>
 * <p>
 ...
 */
final class _AsymmetricEdgeFloat extends EdgeFloat {

  /** the serial version uid */
  private static final long serialVersionUID = 1L;

  /**
   * create the _AsymmetricEdgeFloat
   * 
   * @param n
   *          the number of nodes
   */
  _AsymmetricEdgeFloat(final int n) {
    super(n);
    if (n > 46341) {
