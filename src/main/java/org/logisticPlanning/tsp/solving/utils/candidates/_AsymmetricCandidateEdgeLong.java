 ...
 * </p>
 * <p>
 * A class that assigns on long to each edge, specialized for asymmetric
 * TSPs and using an {@code long} array as backing store. The size of the
 ...
 * corresponding
 * {@link org.logisticPlanning.tsp.solving.utils.edgeData.EdgeLong} data
 ...
 * this matrix will cost you {@code O(log m)} memory accesses.
 * </p>
 * <p>
 ...
 * </p>
 */
final class _AsymmetricCandidateEdgeLong extends CandidateEdgeNumber {
   ...
   *          the candidates
   */
  _AsymmetricCandidateEdgeLong(final int n,
      final _CandidateSubSet candidates) {
    super(n, candidates);
    this.m_data = new long[n * this.m_m];
  }
