 ...
 * TSPs and using an {@code int} array as backing store. The size of the
 ...
 * </p>
 */
final class _AsymmetricCandidateEdgeInt extends CandidateEdgeNumber {
   ...
   *          the candidates
   */
  _AsymmetricCandidateEdgeInt(final int n,
