 ...
 * </p>
 * <p>
 * A class that assigns on double to each edge, specialized for symmetric
 * TSPs and using an {@code double} array as backing store. The size of the
 ...
 * corresponding
 * {@link org.logisticPlanning.tsp.solving.utils.edgeData.EdgeDouble} data
 ...
 * this symmetric version of the {@code double}-array backed
 ...
 * </p>
 */
final class _SymmetricCandidateEdgeDouble extends CandidateEdgeNumber {
   ...
   *          the candidates
   */
  _SymmetricCandidateEdgeDouble(final int n,
      final _CandidateSubSet candidates) {
    super(n, candidates);
    this.m_data = new double[n * this.m_m];
  }

  /** {@inheritDoc} */
  @Override
  public final void clear() {
    Arrays.fill(this.m_data, (0d));
  }
