 ...
 * TSPs and using an {@code byte} array as backing store. The size of the
 ...
 * corresponding
 * {@link org.logisticPlanning.tsp.solving.utils.edgeData.EdgeByte} data
 ...
 * </p>
 */
final class _AsymmetricCandidateEdgeByte extends CandidateEdgeNumber {
   ...
   *          the candidates
   */
  _AsymmetricCandidateEdgeByte(final int n,
      final _CandidateSubSet candidates) {
    super(n, candidates);
    this.m_data = new byte[n * this.m_m];
  }
