 ...
 * single-precision (32-bit) floating point number (float) ({@code float}).
 ...
 * 46'342. Be aware that such a matrix may have a high memory consumption
 ...
 */
final class _SymmetricEdgeFloat extends EdgeFloat {

  /** the serial version uid */
  private static final long serialVersionUID = 1L;

  /**
   * create the _SymmetricEdgeFloat
   * 
   * @param n
   *          the number of nodes
   */
  _SymmetricEdgeFloat(final int n) {
    super(n);
    if (n > 46342) {
    ...
    this.m_data = new float[((int) ((((long) (n)) * ((n) - 1)) >>> 1))];
  }
  ...
  public final long getLong(final int a, final int b) {
    ...
    return ((long) ((this.m_data[((((((i) - 1) * ((i) - 2)) >>> 1) + (j)) - 1)])));
  }
  ...
  public final void setDouble(final int a, final int b, final double value) {
    ...
    this.m_data[((((((i) - 1) * ((i) - 2)) >>> 1) + (j)) - 1)] = ((float) (value));
  }
