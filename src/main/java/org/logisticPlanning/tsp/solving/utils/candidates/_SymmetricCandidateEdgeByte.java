 ...
 * this symmetric version of the {@code byte}-array backed
 ...
 * </p>
 */
final class _SymmetricCandidateEdgeByte extends CandidateEdgeNumber {
   ...
   *          the candidates
   */
  _SymmetricCandidateEdgeByte(final int n,
