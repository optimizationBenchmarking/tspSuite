 ...
 */
final class _SymmetricEdgeDouble extends EdgeDouble {
   ...
   *          the number of nodes
   */
  _SymmetricEdgeDouble(final int n) {
    super(n);
    if (n > 46342) {
    ...
    this.m_data = new double[((int) ((((long) (n)) * ((n) - 1)) >>> 1))];
  }
  ...
  public final float getFloat(final int a, final int b) {
    ...
    return ((float) (this.m_data[((((((i) - 1) * ((i) - 2)) >>> 1) + (j)) - 1)]));
  }
