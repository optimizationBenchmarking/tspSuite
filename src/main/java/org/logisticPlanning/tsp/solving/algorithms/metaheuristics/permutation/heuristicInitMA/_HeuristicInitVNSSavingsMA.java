 ...
 * </ol>
 */
class _HeuristicInitVNSSavingsMA extends _HeuristicInitVNSMA {
   ...
   */
  public _HeuristicInitVNSSavingsMA(final String name) {
    super("with Savings Crossover" + name);//$NON-NLS-1$
  }
