 ...
 * href="#cite_HM2001VNSPAA" style="font-weight:bold">12</a>, <a
 * href="#cite_HMP2008VNSMAA" style="font-weight:bold">13</a>, <a
 * href="#cite_HMP2010VNSMAA" style="font-weight:bold">14</a>], except that
 ...
 * href="#localSearch">local search</a>, it is not entirely clear whether
 * applying selection pressure towards better tours is actually helpful or
 * may just decrease the diversity in the population. Therefore, comparing
 * the results of an algorithm with a standard (&#956;+&#955;) or
 * (&#956;,&#955;) selection method to one that entirely randomly selects
 * parents (i.e., this algorithm here) seems to be a good idea.
 * </p>
 * <p>
 ...
 * </ol>
 */
public final class HeuristicInitRNSEdgeMARandomSelection extends
    _HeuristicInitRNSEdgeMA {
   ...
   * create the ea
   */
  public HeuristicInitRNSEdgeMARandomSelection() {
    super(" and Random Selection");//$NON-NLS-1$
    this.setSelectionAlgorithm(RandomSelection.INSTANCE);
  }

  /**
   * Perform the heuristic init rns edge MA with Random Selection
   *
   * @param args
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        HeuristicInitRNSEdgeMARandomSelection.class,//
        args);
  }
}
