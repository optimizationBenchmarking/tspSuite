 ...
 * style="font-weight:bold">4</a>, <a href="#cite_HMP2008VNSMAA"
 * style="font-weight:bold">5</a>, <a href="#cite_HMP2010VNSMAA"
 * style="font-weight:bold">6</a>] which is repeated until it finds a local
 ...
 *         </ul>
 */
public class BABLittle1963VNS extends _HybridBABLittle1963 {

  /** the serial version uid */
  private static final long serialVersionUID = 1L;

  /** create */
  public BABLittle1963VNS() {
    super(" with VNS"); //$NON-NLS-1$
  }

  /** {@inheritDoc} */
  @Override
  final UnaryOperator<int[]> createUnary() {
    return new PermutationVNSMutation();
  }
