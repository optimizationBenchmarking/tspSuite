 ...
 * </ol>
 */
public final class HeuristicInitMultiNeighborhoodSavingsMARandomSelection
    extends _HeuristicInitMultiNeighborhoodSavingsMA {
   ...
   * create the ea
   */
  public HeuristicInitMultiNeighborhoodSavingsMARandomSelection() {
    super(" and FUSS");//$NON-NLS-1$
    this.setSelectionAlgorithm(RandomSelection.INSTANCE);
  }

  /**
   * Perform the heuristic init mns savings MA with random selection
   * 
   * @param args
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        HeuristicInitMultiNeighborhoodSavingsMARandomSelection.class,//
        args);
  }
}
