...
public final class HeuristicInitMultiNeighborhoodSavingsMAFUSS extends
   ...
   * create the ea
   */
  public HeuristicInitMultiNeighborhoodSavingsMAFUSS() {
    super(" and Random Selection");//$NON-NLS-1$
    this.setSelectionAlgorithm(FitnessUniformSelection.INSTANCE);
  }

  /**
   * Perform the heuristic init mns savings MA with fuss
   * 
   * @param args
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        HeuristicInitMultiNeighborhoodSavingsMAFUSS.class,//
        args);
  }
}
