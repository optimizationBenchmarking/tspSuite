 ...
 * style="font-weight:bold">25</a>] process as fitness assignment method.
 ...
 * result of a <a href="#localSearch">multi-neighborhood search</a>, we
...
_HeuristicInitMultiNeighborhoodSavingsMA {
   ...
   * create the ea
   */
  public HeuristicInitMultiNeighborhoodSavingsMAFFA() {
    super(" with FFA");//$NON-NLS-1$
    this.setFitnessAssignmentProcess(new FFA());
  }

  /**
   * Perform the heuristic init mns savings MA with ffa
   *
   * @param args
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        HeuristicInitMultiNeighborhoodSavingsMAFFA.class,//
        args);
  }
}
