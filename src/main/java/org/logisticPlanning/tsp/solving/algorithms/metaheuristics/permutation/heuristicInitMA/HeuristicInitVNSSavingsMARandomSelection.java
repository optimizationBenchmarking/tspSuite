 ...
 * style="font-weight:bold">11</a>, <a href="#cite_HMP2008VNSMAA"
 * style="font-weight:bold">12</a>, <a href="#cite_HMP2010VNSMAA"
 * style="font-weight:bold">13</a>] which is repeated until it finds a
 ...
 * random selection} as selection algorithm. The rational is that, since
 * all individuals from the population are local optima with respect to <a
 * href="#localSearch">variable neighborhood search</a>, it is not entirely
 * clear whether applying selection pressure towards better tours is
 * actually helpful or may just decrease the diversity in the population.
 * Therefore, comparing the results of an algorithm with a standard
 * (&#956;+&#955;) or (&#956;,&#955;) selection method to one that entirely
 * randomly selects parents (i.e., this algorithm here) seems to be a good
 * idea.
 * </p>
 * <p>
 * Besides purely random selection (as opposed to such a truncation
 * selection) other more sophisticated methods such as
 * {@link org.logisticPlanning.tsp.solving.algorithms.metaheuristics.general.ea.selection.FitnessUniformSelection
 * FUSS}&nbsp;[<a href="#cite_H2006FUO" style="font-weight:bold">28</a>, <a
 * href="#cite_LHK2004TVFUS" style="font-weight:bold">29</a>, <a
 * href="#cite_H2002FUSTPGD" style="font-weight:bold">30</a>, <a
 * href="#cite_LHK2004TVFUS2" style="font-weight:bold">31</a>] or
 * {@link org.logisticPlanning.tsp.solving.algorithms.metaheuristics.general.ea.fitness.FFA
 * FFA}&nbsp;[<a href="#cite_WWTWDY2014FFA"
 * style="font-weight:bold">32</a>] are tested by different MAs in this
 * package as well.
 * </p>
 * </li>
 * </ol>
 ...
 * </ol>
 */
public final class HeuristicInitVNSSavingsMARandomSelection extends
   ...
   * create the ea
   */
  public HeuristicInitVNSSavingsMARandomSelection() {
    super(" and Random Selection");//$NON-NLS-1$
    this.setSelectionAlgorithm(RandomSelection.INSTANCE);
  }

  /**
   * Perform the heuristic init vns savings MA with random selection
   *
   * @param args
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        HeuristicInitVNSSavingsMARandomSelection.class,//
        args);
  }
}
