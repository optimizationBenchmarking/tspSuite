 ...
 * href="#localSearch">multi-neighborhood search</a>, it is not entirely
 ...
 * FUSS}&nbsp;[<a href="#cite_H2006FUO" style="font-weight:bold">25</a>, <a
 * href="#cite_LHK2004TVFUS" style="font-weight:bold">26</a>, <a
 * href="#cite_H2002FUSTPGD" style="font-weight:bold">27</a>, <a
 * href="#cite_LHK2004TVFUS2" style="font-weight:bold">28</a>] or
 * {@link org.logisticPlanning.tsp.solving.algorithms.metaheuristics.general.ea.fitness.FFA
 * FFA}&nbsp;[<a href="#cite_WWTWDY2014FFA"
 * style="font-weight:bold">29</a>] are tested by different MAs in this
 * package as well.
 * </p>
 * </li>
 * </ol>
 ...
 * </ol>
 */
public final class HeuristicInitMultiNeighborhoodEdgeMARandomSelection
    extends _HeuristicInitMultiNeighborhoodEdgeMA {
   ...
   * create the ea
   */
  public HeuristicInitMultiNeighborhoodEdgeMARandomSelection() {
    super(" and Random Selection");//$NON-NLS-1$
    this.setSelectionAlgorithm(RandomSelection.INSTANCE);
  }

  /**
   * Perform the heuristic init mns edge MA with random selection
   *
   * @param args
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        HeuristicInitMultiNeighborhoodEdgeMARandomSelection.class,//
        args);
  }
}
