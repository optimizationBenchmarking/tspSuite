 ...
 */
public class LinKernighan_candiadate_10
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        LinKernighan_candiadate_10.class, args);
  }

  /** create */
  public LinKernighan_candiadate_10() {
  ...
  public TSPAlgorithm clone() {
    final LinKernighan_candiadate_10 x;

    x = ((LinKernighan_candiadate_10) (super.clone()));
    x.m_t = null;
          ...
          if (backType != 0) {
            ...
            if (this.m_xend[q] >= (countOfTempX)) {
              ...
              if (q >= 2) {
                ...
                LinKernighan_candiadate_10.__beforeBacktrack(
            ...
            if (q < 2) {
              ...
              if (!this.m_edgeAdded.hasEdge(
                ...
                if (this.m_edgeSet.deleteEdgeIfExists(
                  ...
                  this.m_t[2 * q] = LinKernighan_candiadate_10
              ...
              if ((!this.m_edgeAdded.hasEdge(
                ...
                if (this.m_edgeSet.deleteEdgeIfExists(
                  ...
                  tourL = srcdst.tourLength
                      - (gain + LinKernighan_candiadate_10.__g(this.m_t[1],
                          this.m_t[2 * q],
                          this.m_tempX[2 * this.m_xend[q]],
          ...
          choseY: for (; this.m_yendCount[q] <= this.m_m; this.m_yendCount[q]++) {
            ...
            if (this.m_edgeSet.getEdges(this.m_yend[q],
              ...
              if ((this.m_yend[q] != this.m_t[(2 * q) - 1])
                  ...
                  && (this.m_yend[q] != LinKernighan_candiadate_10
                ...
                gain += LinKernighan_candiadate_10.__g(this.m_t[2 * q],
