 ...
 * random-neighborhood search} for refining its candidate solutions.
 * </p>
 ...
 * </ol>
 */
public class HeuristicInitRNSPACO extends _HeuristicInitLocalSearchPACO {
   ...
   * instantiate
   */
  public HeuristicInitRNSPACO() {
    super("Random-Neighborhood Search ");//$NON-NLS-1$ 
  }

  /** {@inheritDoc} */
  @Override
  protected final PermutationRNSMutation createLocalSearch() {
  ...
  public static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(//
        Instance.SYMMETRIC_INSTANCES, HeuristicInitRNSPACO.class,//
        args);
  }
}
