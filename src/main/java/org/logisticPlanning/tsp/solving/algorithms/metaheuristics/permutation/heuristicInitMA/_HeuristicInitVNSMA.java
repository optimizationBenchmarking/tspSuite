 ...
 * style="font-weight:bold">8</a>, <a href="#cite_HMP2008VNSMAA"
 * style="font-weight:bold">9</a>, <a href="#cite_HMP2010VNSMAA"
 * style="font-weight:bold">10</a>] which is repeated until it finds a
 ...
 * </ol>
 */
abstract class _HeuristicInitVNSMA extends PermutationHeuristicInitMA {
   ...
   */
  public _HeuristicInitVNSMA(final String name) {
    super(
        "Permutation-based heuristic-initialized VNS Memetic Algorithm " + //$NON-NLS-1$
            name);
  }
