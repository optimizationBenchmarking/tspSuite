 ...
 * <li>
 * <p>
 * The Memetic Algorithm furthermore uses the
 * {@link org.logisticPlanning.tsp.solving.algorithms.metaheuristics.general.ea.fitness.FFA
 * Frequency Fitness Assignment} (FFA)&nbsp;[<a href="#cite_WWTWDY2014FFA"
 * style="font-weight:bold">28</a>] process as fitness assignment method.
 * FFA tries to achieve a uniform number of samples for all possible
 * {@link org.logisticPlanning.tsp.solving.Individual#tourLength tour
 * lengths} over the duration of the whole search process.
 * </p>
 * <p>
 * Of course, there are almost arbitrarily many different tour lengths in a
 * TSP. However, as any individual in the population of the MA always is a
 * result of a <a href="#localSearch">variable neighborhood search</a>, we
 * expect the number to feasible. Furthermore, our
 * {@link org.logisticPlanning.tsp.solving.algorithms.metaheuristics.general.ea.fitness.FFA
 * FFA implementation} limits the overall table length.
 * </p>
 * </li>
 * </ol>
 * <h2>References</h2>
 ...
 * </ol>
 */
public final class HeuristicInitVNSSavingsMAFFA extends
   ...
   * create the ea
   */
  public HeuristicInitVNSSavingsMAFFA() {
    super(" and FFA");//$NON-NLS-1$
    this.setFitnessAssignmentProcess(new FFA());
  }

  /**
   * Perform the heuristic init vns savings MA with FFA
   *
   * @param args
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        HeuristicInitVNSSavingsMAFFA.class,//
        args);
  }
}
