 ...
 * result of a <a href="#localSearch">local search</a>, we expect the
 * number to feasible. Furthermore, our
 * {@link org.logisticPlanning.tsp.solving.algorithms.metaheuristics.general.ea.fitness.FFA
 ...
 * </ol>
 */
public final class HeuristicInitRNSEdgeMAFFA extends
   ...
   * create the ea
   */
  public HeuristicInitRNSEdgeMAFFA() {
    super(" and FFA");//$NON-NLS-1$
    this.setFitnessAssignmentProcess(new FFA());
  }

  /**
   * Perform the heuristic init rns edge MA with FFA
   *
   * @param args
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        HeuristicInitRNSEdgeMAFFA.class,//
        args);
  }
}
