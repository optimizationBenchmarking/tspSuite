 ...
 * structure. The performance of the P_Sec is kind of poor. It should be better than P_Sec,
...
public class F_Sec extends TSPLocalSearchAlgorithm<int[]> {
	...
	/** create */
	public F_Sec() {
		super("F_Sec Algorithm using a fundamental Stem-and-Cycle Datastructure");
	}
