 ...
 * style="font-weight:bold">25</a>, <a href="#cite_LHK2004TVFUS"
 * style="font-weight:bold">26</a>, <a href="#cite_H2002FUSTPGD"
 * style="font-weight:bold">27</a>, <a href="#cite_LHK2004TVFUS2"
 * style="font-weight:bold">28</a>]. FUSS aims at achieving a uniform
 ...
 * </ol>
 */
public final class HeuristicInitMultiNeighborhoodEdgeMAFUSS extends
   ...
   * create the ea
   */
  public HeuristicInitMultiNeighborhoodEdgeMAFUSS() {
    super(" and FUSS");//$NON-NLS-1$
    this.setSelectionAlgorithm(FitnessUniformSelection.INSTANCE);
  }

  /**
   * Perform the heuristic init mns edge MA with fuss
   * 
   * @param args
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        HeuristicInitMultiNeighborhoodEdgeMAFUSS.class,//
        args);
  }
}
