 ...
 * initialized heuristically and each individual is refined with a local
 * search.
 * </p>
 * <p>
...
HeuristicInitTemplateBasedEHBSA {
  ...
  /** the local search parameter: {@value} */
  public static final String PARAM_LOCAL_SEARCH = "ehbsaLocalSearch"; //$NON-NLS-1$
  ...
  /** the temporary individual record */
  private transient TemplateIndividual m_temp;
   ...
   *          the name
   */
  _HeuristicInitRefiningTemplateBasedEHBSA(final String name) {
    super(name);
  ...
  public HeuristicInitTemplateBasedEHBSA clone() {
    ...
    cfg = ((_HeuristicInitRefiningTemplateBasedEHBSA) (super.clone()));
    cfg.m_unary = ((UnaryOperator<int[]>) (this.m_unary.clone()));
    cfg.m_temp = null;
  ...
  public void printConfiguration(final PrintStream ps) {
    ...
    Configurable.printKey(
        _HeuristicInitRefiningTemplateBasedEHBSA.PARAM_LOCAL_SEARCH, ps);
  ...
  public void printParameters(final PrintStream ps) {
    ...
    Configurable.printKey(
        _HeuristicInitRefiningTemplateBasedEHBSA.PARAM_LOCAL_SEARCH, ps);
    ps.println("the unary operator performing the local search"); //$NON-NLS-1$
  }
  ...
  public void configure(final Configuration config) {
    ...
    this.m_unary = config.getInstance(
        _HeuristicInitRefiningTemplateBasedEHBSA.PARAM_LOCAL_SEARCH,
  ...
  protected void refineIndividual(final ObjectiveFunction f,
    ...
    final TemplateIndividual tmp;
    tmp = this.m_temp;
    tmp.assign(ind);
    ind.clear();
    this.m_unary.mutate(ind, f, tmp);
  }
  ...
  public void beginRun(final ObjectiveFunction f) {
    ...
    this.m_temp = new TemplateIndividual();
  }
