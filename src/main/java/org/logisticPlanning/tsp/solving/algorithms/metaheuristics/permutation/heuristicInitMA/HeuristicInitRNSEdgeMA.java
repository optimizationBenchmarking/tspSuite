 ...
 * </ol>
 */
public final class HeuristicInitRNSEdgeMA extends _HeuristicInitRNSEdgeMA {
   ...
   * create the ea
   */
  public HeuristicInitRNSEdgeMA() {
    super("");//$NON-NLS-1$
  }

  /**
   * Perform the heuristic init rns edge MA
   *
   * @param args
