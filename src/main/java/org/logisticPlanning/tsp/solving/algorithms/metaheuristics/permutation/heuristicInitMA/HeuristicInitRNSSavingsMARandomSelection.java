 ...
 * </ol>
 */
public final class HeuristicInitRNSSavingsMARandomSelection extends
   ...
   * create the ea
   */
  public HeuristicInitRNSSavingsMARandomSelection() {
    super(" and Random Selection");//$NON-NLS-1$
    this.setSelectionAlgorithm(RandomSelection.INSTANCE);
  }

  /**
   * Perform the heuristic init rns savings MA with random selection
   *
   * @param args
  ...
  public final static void main(final String[] args) {
    TSPAlgorithmRunner.benchmark(Instance.SYMMETRIC_INSTANCES,
        HeuristicInitRNSSavingsMARandomSelection.class,//
        args);
  }
}
