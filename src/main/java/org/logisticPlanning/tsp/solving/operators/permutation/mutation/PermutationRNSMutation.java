...
/**
 * <p>
 * An mutator that performs a Random Neighborhood Search (RNS)&nbsp;[<a
 * href="#cite_HM2001VNSPAA" style="font-weight:bold">1</a>, <a
 * href="#cite_HMP2008VNSMAA" style="font-weight:bold">2</a>, <a
 * href="#cite_HMP2010VNSMAA" style="font-weight:bold">3</a>] according to
 * the
 * {@link org.logisticPlanning.tsp.solving.algorithms.localSearch.permutation.vns.PermutationRNS
 * LocalNOpt algorithm} and by default returns an individual which is
 ...
 * </ol>
 */
public class PermutationRNSMutation extends
  ...
  public final void setImprovementSelectionPolicy(
    ...
    ((PermutationRNS) (this.getLocalSearchAlgorithm()))
