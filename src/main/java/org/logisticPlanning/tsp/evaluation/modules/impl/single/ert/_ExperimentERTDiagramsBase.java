 ...
 * </ol>
 */
class _ExperimentERTDiagramsBase extends SingleModule {
  ...
  static {
    ...
    s = Macros.ERTi.getPlaceholder();
    _NAME_PFX = ("experiment" + //$NON-NLS-1$
   ...
   */
  _ExperimentERTDiagramsBase(final String name, final Module owner,
      final boolean isActive) {
    super(_ExperimentERTDiagramsBase._NAME_PFX + name + "Diagrams", //$NON-NLS-1$
        owner, isActive);
