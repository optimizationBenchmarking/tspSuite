 ...
 * style="font-weight:bold">3</a>] of all algorithm over a given time
 * measure. See the documentation of the class
...
final class _ExperimentSetERTOverScaleDiagramsHolder extends
  ...
  protected final void writeSectionTitle(final SectionTitle title,
    ...
    title.write(" over Problem Scale for Different Time Measures"); //$NON-NLS-1$
  }
}
