...
/**
 * <p>
 * A point that holds one tuple of information about the Expected Running
 * Time (to Success), ERT in short,&nbsp;[<a href="#cite_HAFR2012RPBBOBES"
 * style="font-weight:bold">1</a>, <a href="#cite_AH2005PEOAALSEA"
 * style="font-weight:bold">2</a>, <a href="#cite_P1997DEVTFOT2I"
 * style="font-weight:bold">3</a>] of an algorithm for a given problem and
 * time measure as subscript.
 * </p>
 * <h2>References</h2>
 * <ol>
 ...
 * </ol>
 */
final class _ERTI extends MacroDefinition {

  /** the serial version uid */
  private static final long serialVersionUID = 1L;

  /** the globally shared instance */
  static final MacroDefinition INSTANCE = new _ERTI();

  /**
   * create
   */
  private _ERTI() {
    super("erti", 1, Macros.ERT.getPlaceholder());//$NON-NLS-1$
  }
   ...
   * with the singleton instance {@link _ERTI#INSTANCE _ERTI.INSTANCE} for
   * serialization, i.e., when the instance is written with
   * {@link java.io.ObjectOutputStream#writeObject(Object)}.
   *
   * @return the replacement instance (always {@link _ERTI#INSTANCE
   *         _ERTI.INSTANCE})
   */
  private final Object writeReplace() {
    return _ERTI.INSTANCE;
  }

  /**
   * Read resolve: The instance this method is invoked on will be replaced
   * with the singleton instance {@link _ERTI#INSTANCE _ERTI.INSTANCE}
