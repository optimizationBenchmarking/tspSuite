...
/**
 * <p>
 * The experiment holder showing diagrams of the Estimated Running Time
 ...
 * </ol>
 */
public final class ExperimentERTHolder extends SingleModule {
   ...
   *          the macro's owner
   */
  public ExperimentERTHolder(final Module owner) {
    super(_ExperimentERTDiagramsBase._NAME_PFX, owner, false);
  }
  ...
  protected final void createChildModules() {
    new _ExperimentERTOverScaleDiagram(this, true);
  }
