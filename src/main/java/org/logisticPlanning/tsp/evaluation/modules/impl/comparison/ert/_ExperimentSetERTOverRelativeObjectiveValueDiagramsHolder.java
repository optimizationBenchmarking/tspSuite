...
/**
 * <p>
 * This evaluator module will print diagrams showing the Estimated Running
 ...
 * style="font-weight:bold">3</a>] of all algorithm over the target
 * objective values. See the documentation of the class
...
final class _ExperimentSetERTOverRelativeObjectiveValueDiagramsHolder
  ...
  protected final void createChildModules() {
    new _ExperimentSetERTOverRelativeObjectiveValueDiagram(this, true);
  }
  ...
  protected final void writeSectionTitle(final SectionTitle title,
    ...
    title.write(" over Relative Objective Value Thresholds"); //$NON-NLS-1$
  }
}
