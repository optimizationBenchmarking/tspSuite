...
/**
 * A module that provides a description of some kind.
 */
public class DescriptionModule extends _ConcreteModule {
   ...
   */
  protected DescriptionModule(final String name, final Module owner,
