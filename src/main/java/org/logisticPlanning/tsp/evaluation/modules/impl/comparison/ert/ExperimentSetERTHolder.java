...
/**
 * <p>
 * The experiment holder for comparative diagrams of the Estimated Running
 ...
 * style="font-weight:bold">3</a>] from different perspectives. See the
 ...
 * </ol>
 */
public final class ExperimentSetERTHolder extends ComparisonModule {
   ...
   *          the macro's owner
   */
  public ExperimentSetERTHolder(final Module owner) {
    super(_ExperimentSetERTDiagramsBase._NAME_PFX, owner, false);
  }
  ...
  protected final void createChildModules() {
    new _ExperimentSetERTOverRelativeObjectiveValueDiagramsHolder(this);
    new _ExperimentSetScaleERTOverRelativeObjectiveValueDiagramsHolder(
        this);
    new _ExperimentSetERTOverScaleDiagramsHolder(this);
  }
