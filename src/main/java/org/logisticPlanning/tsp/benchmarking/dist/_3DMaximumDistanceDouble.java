 ...
 * </p>
 * <p>
 * _3DMaximumDistanceDouble represents list of 3-dimensional
 * double-precision (64-bit) floating point number (double) coordinates
 * between which the Maximum measure is computed as specified in&nbsp;[<a
 ...
 * </ol>
 */
final class _3DMaximumDistanceDouble extends _3DDoubleCoords {
   ...
   *          the dimension
   */
  _3DMaximumDistanceDouble(final int n) {
    super(n);
  }
  ...
  public final int distance(final int i, final int j) {
    ...
    return ((int) (0.5d + (Math.max(Math.abs(x - m[a++]),
  ...
  public final long evaluate(final int[] nodes) {
    ...
    for (final int cur_i : nodes) {
      ...
      totalDist += ((int) (0.5d + (Math.max(Math.abs(x1 - x2),
