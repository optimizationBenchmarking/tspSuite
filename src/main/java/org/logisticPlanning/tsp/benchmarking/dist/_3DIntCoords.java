 ...
 * </p>
 * <p>
 * _3DIntCoords represents a list of 3-dimensional 32 bit signed integer
 * (int) coordinates. This class is internally extended with different
 * distance measures, see {@link _3DManhattanDistanceInt},
 * {@link _3DEuclideanDistanceInt}, {@link _3DMaximumDistanceInt},
 * {@link _3DXRay1DistanceInt}.
 * </p>
 * <p>
 * The layout of this list is such all 3 {@code int} values belonging to
 ...
 */
abstract class _3DIntCoords extends DistanceComputer {
   ...
   *          the dimension
   */
  _3DIntCoords(final int n) {
    super(n);
    this.m_coords = new int[((n) * 3)];
  }
   ...
   *          the z-coordinate
   */
  final void setCoords(final int i, final int x, final int y, final int z) {
    int a;
    int[] c;
