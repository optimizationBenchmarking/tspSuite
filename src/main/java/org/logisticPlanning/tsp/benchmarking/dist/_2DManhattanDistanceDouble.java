 ...
 * </p>
 * <p>
 * _2DManhattanDistanceDouble represents list of 2-dimensional
 ...
 * </ol>
 */
final class _2DManhattanDistanceDouble extends _2DDoubleCoords {
   ...
   *          the dimension
   */
  _2DManhattanDistanceDouble(final int n) {
    super(n);
  }
  ...
  public final int distance(final int i, final int j) {
    ...
    a = ((j - 1) << 1);
    return ((int) (0.5d + (Math.abs(x - m[a++]) + Math.abs(y - m[a]))));
  }
  ...
  public final long evaluate(final int[] nodes) {
    ...
    for (final int cur_i : nodes) {
      ...
      totalDist += ((int) (0.5d + (Math.abs(x2 - x1) + Math.abs(y2 - y1))));
      x2 = x1;
      y2 = y1;
