 ...
 * </p>
 * <p>
 * _3DEuclideanDistanceDouble represents list of 3-dimensional
 ...
 * </ol>
 */
final class _3DEuclideanDistanceDouble extends _3DDoubleCoords {
   ...
   *          the dimension
   */
  _3DEuclideanDistanceDouble(final int n) {
    super(n);
  }
  ...
  public final long evaluate(final int[] nodes) {
    ...
    long totalDist;
    final double[] m;
    double x1, x2, xd, y1, y2, yd, z1, z2, zd;
