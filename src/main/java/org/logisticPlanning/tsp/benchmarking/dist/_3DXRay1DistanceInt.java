 ...
 * </p>
 * <p>
 * _3DXRay1DistanceInt represents list of 3-dimensional 32 bit signed
 * integer (int) coordinates between which the XRay1 measure is computed as
 * specified in&nbsp;[<a href="#cite_R1995T9"
 ...
 * </ol>
 */
final class _3DXRay1DistanceInt extends _3DIntCoords {
   ...
   *          the dimension
   */
  _3DXRay1DistanceInt(final int n) {
    super(n);
  }
  ...
  public final int distance(final int i, final int j) {
    ...
    final int[] m;
    int a;
    final int phiw, phiv, chiw, twothw;
    int t;
    ...
    return ((int) (0.5d + (Math.max(Math.min(t, Math.abs(t - (360))),
  ...
  public final long evaluate(final int[] nodes) {
    ...
    long totalDist;
    final int[] m;
    int phi1, phi2, chi1, chi2, twoth1, twoth2, t;
