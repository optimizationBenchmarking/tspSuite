 ...
 * </p>
 * <p>
 * _2DDoubleCoords represents a list of 2-dimensional double-precision
 * (64-bit) floating point number (double) coordinates. This class is
 * internally extended with different distance measures, see
 * {@link _2DManhattanDistanceDouble}, {@link _2DEuclideanDistanceDouble},
 * {@link _2DCeiledEuclideanDistanceDouble},
 * {@link _2DPseudoEuclideanDistanceDouble}, {@link _2DGeoDistanceDouble},
 * {@link _2DMaximumDistanceDouble}.
 * </p>
 * <p>
 * The layout of this list is such all 2 {@code double} values belonging to
 ...
 */
abstract class _2DDoubleCoords extends DistanceComputer {
   ...
   *          the dimension
   */
  _2DDoubleCoords(final int n) {
    super(n);
    this.m_coords = new double[((n) << 1)];
  }
