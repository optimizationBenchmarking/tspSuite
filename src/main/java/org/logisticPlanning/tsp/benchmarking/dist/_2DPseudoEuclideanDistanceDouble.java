 ...
 * </p>
 * <p>
 * _2DPseudoEuclideanDistanceDouble represents list of 2-dimensional
 * double-precision (64-bit) floating point number (double) coordinates
 * between which the PseudoEuclidean measure is computed as specified
 ...
 * </ol>
 */
final class _2DPseudoEuclideanDistanceDouble extends _2DDoubleCoords {
   ...
   *          the dimension
   */
  _2DPseudoEuclideanDistanceDouble(final int n) {
    super(n);
  }
