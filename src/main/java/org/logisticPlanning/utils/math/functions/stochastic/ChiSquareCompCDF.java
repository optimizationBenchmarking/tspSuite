...
import org.logisticPlanning.utils.math.functions.special.GammaRegularizedP;
 ...
 * </ol>
 */
public final class ChiSquareCompCDF extends BinaryFunction {

  /** the serial version uid */
  private static final long serialVersionUID = 1L;

  /** the globally shared instance */
  public static final ChiSquareCompCDF INSTANCE = new ChiSquareCompCDF();

  /** instantiate */
  private ChiSquareCompCDF() {
    super();
  }
  ...
  public static final double chiSquareCompCDF(final double x, final int dof) {
    ...
    return GammaRegularizedP.INSTANCE.compute(dof >> 1, x * 0.5d);
  ...
  public final double compute(final double x1, final double x2) {
    return ChiSquareCompCDF.chiSquareCompCDF(x1, ((int) (Math.round(x2))));
  }
  ...
  private final Object writeReplace() {
    return ChiSquareCompCDF.INSTANCE;
  }
