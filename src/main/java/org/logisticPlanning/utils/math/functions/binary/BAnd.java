...
public final class BAnd extends BinaryFunction {
   ...
   * with the singleton instance {@link BAnd#INSTANCE INSTANCE} for
   * serialization, i.e., when the instance is written with
   * {@link java.io.ObjectOutputStream#writeObject(Object)}.
   *
   * @return the replacement instance (always {@link BAnd#INSTANCE
   *         INSTANCE})
   */
   ...
   * with the singleton instance {@link BAnd#INSTANCE INSTANCE} after
