...
public final class Pow10 extends UnaryFunction {
   ...
   * with the singleton instance {@link Pow10#INSTANCE INSTANCE} for
   * serialization, i.e., when the instance is written with
   * {@link java.io.ObjectOutputStream#writeObject(Object)}.
   *
   * @return the replacement instance (always {@link Pow10#INSTANCE
   *         INSTANCE})
   */
   ...
   * with the singleton instance {@link Pow10#INSTANCE INSTANCE} after
