...
public final class Min extends BinaryFunction {
   ...
   * with the singleton instance {@link Min#INSTANCE INSTANCE} for
   * serialization, i.e., when the instance is written with
   * {@link java.io.ObjectOutputStream#writeObject(Object)}.
   * 
   * @return the replacement instance (always {@link Min#INSTANCE INSTANCE}
   *         )
   */
   ...
   * with the singleton instance {@link Min#INSTANCE INSTANCE} after
