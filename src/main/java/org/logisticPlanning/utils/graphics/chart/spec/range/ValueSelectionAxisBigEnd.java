 ...
 */
public class ValueSelectionAxisBigEnd extends _ValueSelectionAxisEnd {
   ...
   */
  public ValueSelectionAxisBigEnd(final int dim, final double[] values) {
   ...
   *          the values to choose from
   */
  public ValueSelectionAxisBigEnd(final int dim, final EValueSelector sel,
      final double[] values) {
  ...
  public ValueSelectionAxisBigEnd(final int dim, final EValueSelector sel,
    ...
    super(dim,
        sel, //
        AggregatedAxisEnd._defaultBigPerLineAggregate(perLineAggregate), //
        AggregatedAxisEnd._defaultBigTotalAggregate(totalAggregate),
