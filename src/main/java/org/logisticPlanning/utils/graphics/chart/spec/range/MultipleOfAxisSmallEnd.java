 ...
 */
public final class MultipleOfAxisSmallEnd extends _MultipleOfAxisEnd {
   ...
   *          the step
   */
  public MultipleOfAxisSmallEnd(final int dim, final double step) {
   ...
   *          the step
   */
  public MultipleOfAxisSmallEnd(final int dim, final EValueSelector sel,
      final double step) {
  ...
  public MultipleOfAxisSmallEnd(final int dim, final EValueSelector sel,
    ...
    super(dim, sel, AggregatedAxisEnd
        ._defaultSmallPerLineAggregate(perLineAggregate),
  ...
  protected final double calcEnd(final double aggregate) {
    ...
    d = (this.m_step * Math.floor(aggregate / this.m_step));
