 ...
 * </ol>
 */
public class IEEEArticleDocument extends LaTeXDocument {
   ...
   *           if io fails
   */
  protected IEEEArticleDocument(final IEEEArticleContext context,
  ...
  /** {@inheritDoc} */
  @Override
  public IEEEArticleContext getOwner() {
    return ((IEEEArticleContext) (super.getOwner()));
  }
  ...
  public DocumentDimensions getDimensions() {
    return IEEEArticleDimensions.DEFAULT;
  }
}
