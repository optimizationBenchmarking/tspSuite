...
/**
 * <p>
 * The internal class representing the body of an EPS figure&nbsp;[<a
 * href="#cite_A1992EPFFS" style="font-weight:bold">1</a>, <a
 * href="#cite_W2006AFGTP" style="font-weight:bold">2</a>].
 * </p>
 * <p>
 * <a href="http://en.wikipedia.org/wiki/LaTeX">LaTeX</a>&nbsp;[<a
 * href="#cite_L1994LADPSUGARM" style="font-weight:bold">3</a>, <a
 * href="#cite_GMS1994TLC" style="font-weight:bold">4</a>, <a
 * href="#cite_MGBCR2004TLC" style="font-weight:bold">5</a>, <a
 * href="#cite_OPHS2011TNSSITLOLI1M" style="font-weight:bold">6</a>, <a
 * href="#cite_JF2011LEEUEBM" style="font-weight:bold">7</a>, <a
 * href="#cite_J1995LFAONVDH" style="font-weight:bold">8</a>] is a text
 ...
 * style="font-weight:bold">9</a>], <a href=
 * "http://scripts.sil.org/cms/scripts/page.php?site_id=nrsi&id=xetex"
 * >XeTeX</a>&nbsp;[<a href="#cite_XETEX" style="font-weight:bold">10</a>],
 * or <a href="http://www.tug.org/texlive/">TeX Live</a>&nbsp;[<a
 * href="#cite_TEXLIVE" style="font-weight:bold">11</a>]) to compile such
 * documents to the Portable Document Format (<a
 * href="http://en.wikipedia.org/wiki/Pdf">PDF</a>, &nbsp;[<a
 * href="#cite_ADOBEISO32000" style="font-weight:bold">12</a>, <a
 * href="#cite_ISO320002008" style="font-weight:bold">13</a>]). This
 ...
 * format&nbsp;[<a href="#cite_A1992EPFFS" style="font-weight:bold">1</a>,
 * <a href="#cite_W2006AFGTP" style="font-weight:bold">2</a>] by using the
 ...
 * </ol>
 */
final class _EPSFigureBody extends FigureBody {

  /** the postscript dimension */
  Dimension m_dimInPT;
   ...
   *           if io fails
   */
  _EPSFigureBody(final Element owner, final URI relativeNameBase,
  ...
  /** {@inheritDoc} */
  @Override
  protected final DoubleDimension makeDimensions(final Dimension2D dim) {
    final Dimension d;
    final double w, h;
    ...
    this.m_dimInPT = d = new Dimension(//
        Math.max(1, ((int) (ELength.convert(w, ELength.MM, ELength.PT)))),//
        Math.max(1, ((int) (ELength.convert(h, ELength.MM, ELength.PT)))));

    return new DoubleDimension(//
        Math.min(w, ELength.convert(d.width, ELength.PT, ELength.MM)),//
        Math.min(h, ELength.convert(d.height, ELength.PT, ELength.MM)));
  }
  ...
  final Dimension getDimensionsInPT() {
    return ((Dimension) (this.m_dimInPT.clone()));
  }
  ...
  protected final URI makeRelativeName(final URI relativeNameBase)
      throws URISyntaxException {
    return new URI(relativeNameBase.toString() + ".eps"); //$NON-NLS-1$
  }
