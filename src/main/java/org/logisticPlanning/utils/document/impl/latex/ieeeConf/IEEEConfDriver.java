...
/**
 * A LaTeX driver for IEEE conferences&nbsp;[<a href="#cite_IEEETRAN"
 ...
 * </ol>
 */
public class IEEEConfDriver extends LaTeXDriver {
  /** the serial version uid */
  private static final long serialVersionUID = 1L;

  /** instantiate the driver */
  public IEEEConfDriver() {
    super("IEEE Conference LaTeX"); //$NON-NLS-1$
  }

  /** {@inheritDoc} */
  @Override
  public IEEEConfContext createContext(final File dir) throws IOException {
    return new IEEEConfContext(this, dir);
  }
}
