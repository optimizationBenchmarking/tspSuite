...
/**
 * A LaTeX driver for ACM conferences&nbsp;[<a href="#cite_ACMSIGALTERNATE"
 ...
 * </ol>
 */
public class ACMConfDriver extends LaTeXDriver {
  /** the serial version uid */
  private static final long serialVersionUID = 1L;

  /** instantiate the driver */
  public ACMConfDriver() {
    super("ACM Conference Paper"); //$NON-NLS-1$
  }

  /** {@inheritDoc} */
  @Override
  public ACMConfContext createContext(final File dir) throws IOException {
    return new ACMConfContext(this, dir);
  }
}
