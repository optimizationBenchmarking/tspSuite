 ...
 * IEEE Article&nbsp;[<a href="#cite_IEEETRAN"
 ...
 * </ol>
 */
public class IEEEArticleDimensions extends LaTeXDocumentDimensions {

  /** the default instance */
  static final IEEEArticleDimensions DEFAULT = new IEEEArticleDimensions();

  /** the paper height in mm */
  private static final double PAGE_HEIGHT_MM = ELength.convert(696d,
  ...
  /** instantiate */
  protected IEEEArticleDimensions() {
    super();
  }
  ...
  public double getPageHeightMM() {
    return IEEEArticleDimensions.PAGE_HEIGHT_MM;
  }

  /** {@inheritDoc} */
  @Override
  public double getColumnWidthMM() {
    return IEEEArticleDimensions.COLUMN_WIDTH_MM;
  }

  /** {@inheritDoc} */
  @Override
  public double getPageWidthMM() {
    return IEEEArticleDimensions.PAGE_WIDTH_MM;
  }
