...
/**
 * <p>
 * This class allows us to access (approximate) size information regarding
 * a <a href="http://en.wikipedia.org/wiki/LaTeX">LaTeX</a> document.
 * </p>
 * <p>
 ...
 */
public class LaTeXDocumentDimensions extends DocumentDimensions {

  /** the default instance */
  static final LaTeXDocumentDimensions DEFAULT = new LaTeXDocumentDimensions();

  /** the paper height in mm */
  private static final double PAGE_HEIGHT_MM = ELength.convert(595.80026d,
      ELength.PT, ELength.MM);
  /** the column width in mm */
  private static final double COLUMN_WIDTH_MM = ELength.convert(360d,
      ELength.PT, ELength.MM);
  /** the paper width in mm */
  private static final double PAGE_WIDTH_MM = LaTeXDocumentDimensions.COLUMN_WIDTH_MM;

  /** instantiate */
  protected LaTeXDocumentDimensions() {
    super();
  }
  ...
  public double getPageHeightMM() {
    return LaTeXDocumentDimensions.PAGE_HEIGHT_MM;
  }

  /** {@inheritDoc} */
  @Override
  public double getColumnWidthMM() {
    return LaTeXDocumentDimensions.COLUMN_WIDTH_MM;
  }

  /** {@inheritDoc} */
  @Override
  public double getPageWidthMM() {
    return LaTeXDocumentDimensions.PAGE_WIDTH_MM;
  }
