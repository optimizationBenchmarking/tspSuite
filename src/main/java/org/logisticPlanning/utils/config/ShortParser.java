...
/**
 * A parser takes an object and translates it to a {@link java.lang.Short}
 ...
 * {@link java.lang.Short}. This allows you to query an {@code int}eger
 * after querying a {@code long}.
 */
public final class ShortParser extends Parser<java.lang.Number> {
  ...
  /**
   * Create an {@code ShortParser} instance.
   *
   * @param min
  ...
  public final java.lang.Number parse(final Object value) {
    ...
    check: {
      find: {
        ...
        if (value instanceof String) {
          number = TextUtils.parseShort((String) value);
        } else {
          break check;
        }

        ret = java.lang.Short.valueOf(number);
      } // end of find
    ...
    throw new _ClassError(value.getClass(), java.lang.Short.class);
  }
