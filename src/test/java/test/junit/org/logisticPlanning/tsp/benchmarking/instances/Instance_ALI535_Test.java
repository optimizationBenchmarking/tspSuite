 ...
 * &nbsp;[<a href="#cite_PR1987OOA5CSTSPBBAC"
 * style="font-weight:bold">1</a>] from <a
 * href="http://comopt.ifi.uni-heidelberg.de/software/TSPLIB95/"
 * >TSPLib</a>. We test both, loaded distance computers which are raw
 * (i.e., potentially based on coordinate lists), and those which use
 * matrices backing the results. <h2>References</h2>
 * <ol>
 ...
 * </ol>
 */
public class Instance_ALI535_Test extends _InstanceTest {

  /**
   * test the instance
   * {@link org.logisticPlanning.tsp.benchmarking.instances.Instance#ALI535}
   */
  public Instance_ALI535_Test() {
    super(Instance.ALI535);
  }
}
