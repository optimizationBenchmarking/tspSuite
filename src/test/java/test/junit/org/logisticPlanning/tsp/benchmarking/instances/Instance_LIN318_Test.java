 ...
 * &nbsp;[<a href="#cite_LK1973AEHAFTTSP" style="font-weight:bold">2</a>,
 * <a href="#cite_PG1985PC" style="font-weight:bold">3</a>, <a
 * href="#cite_MOF1991LSMCFTTSP" style="font-weight:bold">4</a>] from <a
 * href
 * ="http://comopt.ifi.uni-heidelberg.de/software/TSPLIB95/">TSPLib</a>. We
 * test both, loaded distance computers which are raw (i.e., potentially
 * based on coordinate lists), and those which use matrices backing the
 * results. <h2>References</h2>
 * <ol>
 ...
 * </ol>
 */
public class Instance_LIN318_Test extends _InstanceTest {

  /**
   * test the instance
   * {@link org.logisticPlanning.tsp.benchmarking.instances.Instance#LIN318}
   */
  public Instance_LIN318_Test() {
    super(Instance.LIN318);
  }
}
