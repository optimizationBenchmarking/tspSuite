...
import org.logisticPlanning.tsp.solving.algorithms.metaheuristics.general.ea.populationResize.AlwaysGrow;
import org.logisticPlanning.tsp.solving.algorithms.metaheuristics.permutation.ea.PermutationEA;

import test.junit.org.logisticPlanning.tsp.solving.algorithms.TSPAlgorithmSymmetricTest;

/**
 * the test of the permutation EA with ever-growing population
 */
public class PermutationEAParentsSurviveAlwaysGrowTest extends
    TSPAlgorithmSymmetricTest {

  /** create */
  public PermutationEAParentsSurviveAlwaysGrowTest() {
    super();
  }
  ...
  protected PermutationEA createAlgorithm() {
    ...
    res.setResizeStrategy(new AlwaysGrow());
